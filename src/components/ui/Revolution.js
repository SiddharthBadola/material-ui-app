    ...
    <Grid container direction="column">
      ...
      >
        ...
        <Grid
          item
          lg
          style={{ marginLeft: matchesMD ? "0" : "5em", maxWidth: "40em" }}
        >
      ...
      <Grid
        ...
        direction={matchesMD ? "column" : "row"}
        className={classes.rowContainer}
        style={{ backgroundColor: "#FBB03B", height: "100em" }}
      >
        <Grid
          item
          container
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            style={{ maxWidth: matchesMD ? "700px" : "1000px", width: "100%" }}
          />
        </Grid>
      </Grid>
      {/*--- Launch Process Row ---*/}
